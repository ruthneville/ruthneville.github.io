...
<p> Please refer to <a href="https://github.com/ruthneville/Practical-1-Agent-Based-Model">" my GitHub repository </a> "Practical 1 Agent Based Model" for the final code of the Agent and the Model that ran successfully - Agent Framework.py and Final Model - Animation Practical.py. The repository also includes a ReadMe file and a license agreement. I am open to feedback on the model on how it can be made more efficient. </p>
